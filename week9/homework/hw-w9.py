...
model.add(Conv2D( 30, kernel_size=(5,5), activation='relu' )) # 8x8x40
...
plot_model(model, to_file='cnn-mnist-regularized.png', show_shapes=True)
model.summary()
...
t0 = time()
model.fit(AX, AY2, batch_size=50, epochs=35, verbose=2) # batch_size=100
t1 = time()
...
model.save('cnn-mnist-regularized.h5')
